  ...
  useEffect(() => {
    const bootstrapAsync = async () => {
      const Populer = await fetch(
        `https://api.themoviedb.org/3/discover/movie?api_key=${api_key}&language=TR&sort_by=popularity.desc&include_adult=false&include_video=true&page=1`,
      )
